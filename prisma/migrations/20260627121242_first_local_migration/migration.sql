...
CREATE TABLE "transactions" (
    ...
    "montantCDF" DECIMAL(10,2),
    "montantUSD" DECIMAL(10,2),
    "tauxChange" DECIMAL(10,2),
    "taux_change" DECIMAL(10,2),
    "montant_usd" DECIMAL(10,2),
    "montant_cdf" DECIMAL(10,2),
...
-- CreateIndex
CREATE INDEX "idx_rapports_created_at" ON "rapports_departement"("created_at");

-- CreateIndex
CREATE INDEX "idx_rapports_departement" ON "rapports_departement"("departement_id");

-- CreateIndex
CREATE INDEX "idx_rapports_periode" ON "rapports_departement"("periode");
